        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button disabled={note.etitle.length < 5 || note.edescription.length < 5} onClick={hindleclick} type="button" className="btn btn-primary">Update Note</button>
            </div>
          </div>
        </div>
      </div>
